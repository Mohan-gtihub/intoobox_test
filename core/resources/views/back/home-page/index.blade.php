                ...
                <div class="row">
                    <div class="col-5 col-md-3">
                        <div class="nav flex-column nav-pills nav-secondary" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link" id="v-pills-t8-tab" data-toggle="pill" href="#v-pills-t8" role="tab" aria-controls="v-pills-t8" aria-selected="false">{{ __('Popular Categories') }}</a>
                            <a class="nav-link active" id="v-pills-t9-tab" data-toggle="pill" href="#v-pills-t9" role="tab" aria-controls="v-pills-t9"
                                aria-selected="true">{{ __('Shop By Categories Banner') }}</a>

                            <a class="nav-link" id="v-pills-t10-tab" data-toggle="pill" href="#v-pills-t10" role="tab" aria-controls="v-pills-t10"
                                aria-selected="false">{{ __('Home Page 8 Super Items') }}</a>
                            <a class="nav-link" id="v-pills-t4-tab" data-toggle="pill" href="#v-pills-t4" role="tab" aria-controls="v-pills-t4"
                                aria-selected="false">{{ __('Featured Categories') }}</a>
                            <a class="nav-link" id="v-pills-t5-tab" data-toggle="pill" href="#v-pills-t5" role="tab" aria-controls="v-pills-t5" aria-selected="false">{{ __('Home Mobile Banners') }}</a>
                        </div>
                    </div>
                    <div class="col-7 col-md-9">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-t9" role="tabpanel" aria-labelledby="v-pills-t9-tab">
                                <form class="admin-form" action="{{ route('back.hero.banner.update') }}"method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <img class="admin-img" src="{{ isset($hero_banner['img1']) ? asset('assets/images/' . $hero_banner['img1']) : asset('assets/images/placeholder.png') }}"
                                            alt="No Image Found">
                                        <br>
                                ...
                                <form class="admin-form" action="{{ route('back.home4.category.update') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <select name="home_4_popular_category[]" id="basic" class="form-control" multiple data-href="{{ route('back.get.childcategory') }}">
                                        @foreach (DB::table('categories')->whereStatus(1)->get() as $category)
                                            <option value="{{ $category->id }}" {{ in_array($category->id, $home_4_popular_category) ? 'selected' : '' }}>
                            ...
                            <div class="tab-pane fade" id="v-pills-t10" role="tabpanel" aria-labelledby="v-pills-t10-tab">
                                <form class="admin-form" action="{{ route('back.home8.itme.update') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @php
                                    ...
                                    <select name="home_8_popular_item[]" id="basic2" class="form-control" multiple>
                                        @foreach (DB::table('items')->whereStatus(1)->get() as $item)
                                            <option value="{{ $item->id }}" {{ in_array($item->id, $home_8_popular_item) ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="v-pills-t4" role="tabpanel" aria-labelledby="v-pills-t4-tab">
                                <form class="admin-form" action="{{ route('back.feature.category.update') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="feature_title" class="form-control" id="feature_title" placeholder="{{ __('Feture Category') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id1" id="feature_category_id1" data-href="{{ route('back.get.subcategory') }}" class="form-control">
                                            ...
                                            @foreach (DB::table('categories')->whereStatus(1)->get() as $cat)
                                                <option value="{{ $cat->id }}" {{ $cat->id == $feature_category['category_id1'] ? 'selected' : '' }}>
                                                    {{ $cat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="subcategory_id1" id="feature_subcategory_id1" class="form-control" data-href="{{ route('back.get.childcategory') }}">
                                            ...
                                            @foreach (DB::table('subcategories')->where('category_id', $feature_category['category_id1'])->whereStatus(1)->get() as $subcat)
                                                <option value="{{ $subcat->id }}" {{ $subcat->id == $feature_category['subcategory_id1'] ? 'selected' : '' }}>
                                                    {{ $subcat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id1" id="feature_childcategory_id1" class="form-control">
                                            ...
                                            @foreach (DB::table('chield_categories')->where('category_id', $feature_category['category_id1'])->whereStatus(1)->get() as $chieldcategory)
                                                <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $feature_category['childcategory_id1'] ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id2" id="feature_category_id2" data-href="{{ route('back.get.subcategory') }}" class="form-control">
                                            <option value="">{{ __('Select One') }}</option>
                                            @foreach (DB::table('categories')->whereStatus(1)->get() as $cat)
                                                <option value="{{ $cat->id }}" {{ $cat->id == $feature_category['category_id2'] ? 'selected' : '' }}>
                                                    {{ $cat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="subcategory_id2" id="feature_subcategory_id2" class="form-control" data-href="{{ route('back.get.childcategory') }}">
                                            ...
                                            @foreach (DB::table('subcategories')->where('category_id', $feature_category['category_id2'])->whereStatus(1)->get() as $subcat)
                                                <option value="{{ $subcat->id }}" {{ $subcat->id == $feature_category['subcategory_id2'] ? 'selected' : '' }}>
                                                    {{ $subcat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id2" id="feature_childcategory_id2" class="form-control">
                                            ...
                                            @foreach (DB::table('chield_categories')->where('category_id', $feature_category['category_id2'])->whereStatus(1)->get() as $chieldcategory)
                                                <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $feature_category['childcategory_id2'] ? 'selected' : '' }}>
                                                    {{ $chieldcategory->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id3" id="feature_category_id3" data-href="{{ route('back.get.subcategory') }}" class="form-control">
                                            <option value="">{{ __('Select One') }}</option>
                                            @foreach (DB::table('categories')->whereStatus(1)->get() as $cat)
                                                <option value="{{ $cat->id }}" {{ $cat->id == $feature_category['category_id3'] ? 'selected' : '' }}>
                                                    {{ $cat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="subcategory_id3" id="feature_subcategory_id3" class="form-control" data-href="{{ route('back.get.childcategory') }}">
                                            ...
                                            @foreach (DB::table('subcategories')->where('category_id', $feature_category['category_id3'])->whereStatus(1)->get() as $subcat)
                                                <option value="{{ $subcat->id }}" {{ $subcat->id == $feature_category['subcategory_id3'] ? 'selected' : '' }}>
                                                    {{ $subcat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id3" id="feature_childcategory_id3" class="form-control">
                                            ...
                                            @foreach (DB::table('chield_categories')->where('category_id', $feature_category['category_id3'])->whereStatus(1)->get() as $chieldcategory)
                                                <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $feature_category['childcategory_id3'] ? 'selected' : '' }}>
                                                    {{ $chieldcategory->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id4" id="feature_category_id4" data-href="{{ route('back.get.subcategory') }}" class="form-control">
                                            <option value="">{{ __('Select One') }}</option>
                                            @foreach (DB::table('categories')->whereStatus(1)->get() as $cat)
                                                <option value="{{ $cat->id }}" {{ $cat->id == $feature_category['category_id4'] ? 'selected' : '' }}>
                                                    {{ $cat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="subcategory_id4" id="feature_subcategory_id4" class="form-control" data-href="{{ route('back.get.childcategory') }}">
                                            ...
                                            @foreach (DB::table('subcategories')->where('category_id', $feature_category['category_id4'])->whereStatus(1)->get() as $subcat)
                                                <option value="{{ $subcat->id }}" {{ $subcat->id == $feature_category['subcategory_id4'] ? 'selected' : '' }}>
                                                    {{ $subcat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id4" id="feature_childcategory_id4" class="form-control">
                                            ...
                                            @foreach (DB::table('chield_categories')->where('category_id', $feature_category['category_id4'])->whereStatus(1)->get() as $chieldcategory)
                                                <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $feature_category['childcategory_id4'] ? 'selected' : '' }}>
                                                    {{ $chieldcategory->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-t5" role="tabpanel" aria-labelledby="v-pills-t5-tab">
                                <form class="admin-form" action="{{ route('back.mobile.banners.update') }}" method="POST">
                                    @csrf
                                    <h2 class=""><b>{{ __('Banner One:') }}</b></h2>

                                    <div class="form-group">
                                        <label for="banner_url1">{{ __('URL') }} *</label>
                                        <input type="text" name="banner_url1" class="form-control" id="banner_url1" placeholder="https://intoobox.com/"
                                            value="{{ isset($home_mobile_banners) ? $home_mobile_banners['banner_url1'] : '' }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="feature_subcategory_id1">{{ __('Banner') }} </label>
                                        <div class="position-relative ">
                                            <label class="text-sm"><small>{{ __('Image Size Should Be 720 x 345. or square size') }}</small></label>
                                            <div class="input-group" data-toggle="aizuploader" data-multiple="false">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text bg-soft-secondary font-weight-medium">
                                                        {{ trans('Browse') }}</div>
                                                </div>
                                                <div class="form-control file-amount {{ $errors->has('banner_id1') ? ' is-invalid' : '' }}">{{ trans('Choose File') }}</div>
                                                <input type="hidden" name="banner_id1" value="{{ isset($home_mobile_banners) ? $home_mobile_banners['banner_id1'] : old('banner_id1') }}" class="selected-files"
                                                    required>
                                                @if ($errors->has('banner_id1'))
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $errors->first('banner_id1') }}</strong>
                                                    </span>
                                                @endif
                                            </div>
                                    ...
                                    <hr>
                                    <h2 class=""><b>{{ __('Banner Two:') }}</b></h2>
                                    <div class="form-group">
                                        <label for="banner_url2">{{ __('URL') }} *</label>
                                        <input type="text" name="banner_url2" class="form-control" id="banner_url2" placeholder="https://intoobox.com/"
                                            value="{{ isset($home_mobile_banners) ? $home_mobile_banners['banner_url2'] : '' }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="feature_subcategory_id1">{{ __('Banner') }} </label>
                                        <div class="position-relative ">
                                            ...
                                            <div class="input-group" data-toggle="aizuploader" data-multiple="false">
                                                ...
                                                <div class="form-control file-amount {{ $errors->has('banner_id2') ? ' is-invalid' : '' }}">{{ trans('Choose File') }}</div>
                                                <input type="hidden" name="banner_id2" value="{{ isset($home_mobile_banners) ? $home_mobile_banners['banner_id2'] : old('banner_id2') }}" class="selected-files"
                                                    required>
                                                @if ($errors->has('banner_id2'))
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $errors->first('banner_id2') }}</strong>
                                                    </span>
                                                @endif
                                            </div>
                                            <div class="file-preview"></div>
                                    ...
                                    <hr>
                                    <h2 class=""><b>{{ __('Banner Three:') }}</b></h2>
                                    <div class="form-group">
                                        <label for="banner_url3">{{ __('URL') }} *</label>
                                        <input type="text" name="banner_url3" class="form-control" id="banner_url3" placeholder="https://intoobox.com/"
                                            value="{{ isset($home_mobile_banners) ? $home_mobile_banners['banner_url3'] : '' }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="feature_subcategory_id1">{{ __('Banner') }} </label>
                                        <div class="position-relative ">
                                            ...
                                            <div class="input-group" data-toggle="aizuploader" data-multiple="false">
                                                ...
                                                <div class="form-control file-amount {{ $errors->has('banner_id3') ? ' is-invalid' : '' }}">{{ trans('Choose File') }}</div>
                                                <input type="hidden" name="banner_id3" value="{{ isset($home_mobile_banners) ? $home_mobile_banners['banner_id3'] : old('banner_id3') }}" class="selected-files"
                                                    required>
                                                @if ($errors->has('banner_id3'))
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $errors->first('banner_id3') }}</strong>
                                                    </span>
                                                @endif
                                            </div>
                                            <div class="file-preview"></div>
                                    ...
                                    <hr>
                                    <h2 class=""><b>{{ __('Banner Four:') }}</b></h2>
                                    <div class="form-group">
                                        <label for="banner_url4">{{ __('URL') }} *</label>
                                        <input type="text" name="banner_url4" class="form-control" id="banner_url4" placeholder="https://intoobox.com/"
                                            value="{{ isset($home_mobile_banners) ? $home_mobile_banners['banner_url4'] : '' }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="feature_subcategory_id1">{{ __('Banner') }} </label>
                                        <div class="position-relative ">
                                            ...
                                            <div class="input-group" data-toggle="aizuploader" data-multiple="false">
                                                ...
                                                <div class="form-control file-amount {{ $errors->has('banner_id4') ? ' is-invalid' : '' }}">{{ trans('Choose File') }}</div>
                                                <input type="hidden" name="banner_id4" value="{{ isset($home_mobile_banners) ? $home_mobile_banners['banner_id4'] : old('banner_id4') }}" class="selected-files"
                                                    required>
                                                @if ($errors->has('banner_id4'))
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $errors->first('banner_id4') }}</strong>
                                                    </span>
                                                @endif
                                            </div>
                                            <div class="file-preview"></div>
