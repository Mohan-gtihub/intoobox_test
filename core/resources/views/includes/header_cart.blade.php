...
@if (Session::has('cart'))
                                ...
                                <div class="cart-item d-flex align-items-start justify-content-between mb-8 pe-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-5 text-end py-3">
                                            <div class="entry-delete"><a class="btn btn-danger btn-sm text-white  border-0" href="{{ route('front.cart.destroy', $key) }}">Remove</a></div>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="checkout-offcanvas-cart-btn mt-8">
                            <a href="{{ route('front.cart') }}" class="btn btn-danger text-white btn-block w-100 rounded-0 text-uppercase py-3  border-0">VIEW CART</a>
