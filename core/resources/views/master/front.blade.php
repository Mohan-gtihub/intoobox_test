                    ...
                    <nav class="slideable-menu">
                        <ul>
                            @if (!Auth::user())
                                <li class="">
                                    <div class="mt-8 px-4 ">
                                        <a href="{{ route('user.login') }}" class="btn btn-danger w-100 text-white  border-0">Login</a>
                                    </div>
                                </li>
                            @else
                                @php
                        ...
                        <ul class="user-list bg-white rounded-3 ps-0 mb-0 shadow-lg">
                            @if (!Auth::user())
                                <li class="user-list-item px-4 py-2 user-info-avatar">
                                    ...
                                    <a href="{{ route('user.login') }}" class="btn btn-danger text-white btn-block text-capitalize w-100 py-3 shadow-0 outline-0 text-uppercase border-0">
                                        Sign in
                                    </a>
                                </li>
                            @else
                            ...
                            <div class="col-lg-6 px-4 px-md-8 px-lg-12 d-flex flex-column align-items-center">
                                ...
                                <form class="subscriber-form mt-4" action="{{ route('front.subscriber.submit') }}">
                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-dark text-white btn-block w-100 py-4 shadow-0 outline-0 rounded-0 text-uppercase border-0">
                                                Subscribe Now
                                            </button>
                                        </div>
                                    </div>
