    ...
    <section class="cart-section my-6 my-lg-8">
        ...
        <div class="container">
            ...
            <div class="d-flex align-items-center justify-content-center mt-4">
                ...
                <div>
                    <a href="https://intoobox.com/catalog" class="fs-16 ms-2 fw text-dark">Shop</a>
                </div>
                <div class="text-gray-700 ms-2">-</div>
                                    ...
                                    <div class="position-relative overflow-hidden">
                                        ...
                                        <div class="quick-add-btn position-absolute">
                                            @if ($related->item_type != 'affiliate')
                                                @if ($related->is_stock())
                                                    <button class="btn btn-danger py-1 py-lg-2 my-0 btn-block w-100 text-white product-button add_to_single_cart shadow-none" data-target="{{ $related->id }}">Quick
                                                        Add</button>
                                                @else
                                                    <button class="btn btn-danger py-1 py-lg-2 my-0 btn-block w-100 text-white product-button add_to_single_cart shadow-none" data-target="{{ $related->id }}"
                                                        disabled>Quick
                                                        Add</button>
                                                @endif
                                            @else
                                                <a class="btn btn-danger py-1 py-lg-2 my-0 btn-block w-100 text-white shadow-none" href="{{ $related->affiliate_link }}" target="_blank"
