                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="quick-add-btn position-absolute">
                            @if ($item->item_type != 'affiliate')
                                @if ($item->is_stock())
                                    <button class="btn btn-danger py-2  my-0 shadow-none btn-block w-100 text-white product-button add_to_single_cart" data-target="{{ $item->id }}">Quick
                                        Add</button>
                                @else
                                    <button class="btn btn-danger py-2  my-0 shadow-none btn-block w-100 text-white product-button add_to_single_cart" data-target="{{ $item->id }}" disabled>Quick
                                        Add</button>
                                @endif
                            @else
                                <a class="btn btn-danger py-2  my-0 btn-block w-100 text-dark shadow-none" href="{{ $item->affiliate_link }}" target="_blank"
                            ...
                            <div class="col-lg-4">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <div class="quick-add-btn position-absolute">
                                        @if ($item->item_type != 'affiliate')
                                            @if ($item->is_stock())
                                                <button class="btn btn-danger py-1 py-lg-2  my-0 btn-block w-100 text-white product-button add_to_single_cart" data-target="{{ $item->id }}">Quick
                                                    Add</button>
                                            @else
                                                <button class="btn btn-danger py-1 py-lg-2  my-0 btn-block w-100 text-white product-button add_to_single_cart" data-target="{{ $item->id }}" disabled>Quick
                                                    Add</button>
                                            @endif
                                        @else
