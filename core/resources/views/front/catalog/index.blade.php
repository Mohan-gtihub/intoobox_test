...
@endphp
  ...
  <section class="filter-section bg-gray-100 py-0 py-lg-4">
    <div class="container">
      <div class="row">
        <div class="filter quickFilter col-12 col-lg-3 py-2 d-inline-flex align-items-center justify-content-center justify-content-lg-start">
          <span class="text-dark"> Filter </span>
          <span class="ms-6 text-dark" id="filter-toggle">
  ...
  <!-- Products section ends here -->
    ...
    filterToggle.addEventListener('click', function() {
        if (quickFilter.style.display === 'none' || quickFilter.style.display === '') {
