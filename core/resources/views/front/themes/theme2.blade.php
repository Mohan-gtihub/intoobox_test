...
@section('content')
    ...
    <main class="main-content">
        ...
        @if(isset($mobile_banners))
        <section class="categories-section px-0 d-lg-none d-sm-block">
            <div class="row p-2 g-3">
                
                @for($i = 1; $i <= 4; $i++)
                    <div class="col-6">
                        <a href="{{ $mobile_banners['banner_url' . $i] }}">
                            <img src="{{ uploaded_asset($mobile_banners['banner_id' . $i]) }}" alt="banner" class="img-fluid rounded" />
                        </a>
                    </div>
                @endfor
                                        ...
                                        <div class="position-relative overflow-hidden">
                                            ...
                                            <div class="quick-add-btn position-absolute">
                                                @if ($feature_category_item->item_type != 'affiliate')
                                                    @if ($feature_category_item->is_stock())
                                                        <button class="btn btn-danger py-1 py-lg-2 my-0 btn-block w-100 text-white product-button add_to_single_cart shadow-none"
                                                            data-target="{{ $feature_category_item->id }}">Quick
                                                            Add</button>
                                                    @else
                                                        <a class="btn btn-danger py-1 py-lg-2 my-0 btn-block w-100 text-white shadow-none" href="{{ route('front.product', $feature_category_item->slug) }}"
                                                            title="{{ __('Details') }}"><i class="icon-arrow-right"></i></a>
                                                    @endif
                                                @else
                                                    <a class="btn btn-danger py-1 py-lg-2 my-0 btn-block w-100 text-white" href="{{ $feature_category_item->affiliate_link }}" target="_blank"
                            ...
                            <div class="col-6 col-lg-3 d-flex flex-column prod-column align-items-center position-relative overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <div class="quick-add-btn position-absolute">
                                        @if ($item->item_type != 'affiliate')
                                            @if ($item->is_stock())
                                                <button class="btn btn-danger py-1 py-lg-2 my-0 btn-block w-100 text-white product-button add_to_single_cart shadow-none text-white"
                                                    data-target="{{ $item->id }}">Quick
                                                    Add</button>
                                            @else
                                                <button class="btn btn-danger py-1 py-lg-2 my-0 btn-block w-100 text-white product-button add_to_single_cart shadow-none text-white" data-target="{{ $item->id }}"
                                                    disabled>Quick
                                                    Add</button>
                                            @endif
                                        @else
                                            <a class="btn btn-danger py-1 py-lg-2 my-0 btn-block w-100 text-white" href="{{ $item->affiliate_link }}" target="_blank"
                ...
                <div class="mt-6 mt-8">
                    <div class="row g-4">
                        <div class="col-md-6 position-relative col-lg-3 d-flex flex-column align-items-center overflow-hidden">
                            <img src="{{ asset('assets/frontend/images/luxury-prod-1.png') }}" alt="Image 1" class="img-fluid luxury-prod-img no-download cursor-pointer"
                        ...
                        <div class="col-md-6 position-relative col-lg-3 d-flex flex-column align-items-center overflow-hidden">
                            <img src="{{ asset('assets/frontend/images/luxury-prod-2.png') }}" alt="Image 1" class="img-fluid luxury-prod-img no-download cursor-pointer"
                        ...
                        <div class="col-md-6 position-relative col-lg-3 d-flex flex-column align-items-center overflow-hidden">
                            <img src="{{ asset('assets/frontend/images/luxury-prod-3.png') }}" alt="Image 1" class="img-fluid luxury-prod-img no-download cursor-pointer"
                        ...
                        <div class="col-md-6 position-relative col-lg-3 d-flex flex-column align-items-center overflow-hidden">
                            <img src="{{ asset('assets/frontend/images/luxury-prod-4.png') }}" alt="Image 1" class="img-fluid luxury-prod-img no-download cursor-pointer"
