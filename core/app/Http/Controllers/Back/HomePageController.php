...
class HomePageController extends Controller
{
    ...
    public function index(){
        ...
        return view('back.home-page.index',[
            ...
            'home_mobile_banners' => json_decode($data->home_mobile_banners,true),
            'home_8_popular_item' => json_decode($data->home_8_popular_item,true),
        ]);
    }
    ...
    public function homemobilebannerspdate(Request $request)
    {
        $request->validate([
            'banner_id1' => 'required',
            'banner_id2' => 'required',
            'banner_id3' => 'required',
            'banner_id4' => 'required',
            'banner_url1' => 'required',
            'banner_url2' => 'required',
            'banner_url3' => 'required',
            'banner_url4' => 'required',
        ]);
        ...
        $data->home_mobile_banners = json_encode($input,true);
        $data->update();
        return redirect()->back()->withSuccess(__('Banner Update Successfully'));
    ...
    public function homepage8itemupdate(Request $request)
    {
       $item = json_encode($request->home_8_popular_item,true);
       
       $data = HomeCutomize::first();
       $data->home_8_popular_item = $item;
       $data->update();
       return redirect()->back()->withSuccess(__('Items Update Successfully'));
